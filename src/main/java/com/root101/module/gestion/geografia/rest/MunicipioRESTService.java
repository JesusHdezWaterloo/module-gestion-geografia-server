 ...
 */
@RestController
@RequestMapping(value = MUNICIPIO_GENERAL_PATH)
public class MunicipioRESTService extends RESTServiceTemplate<MunicipioDomain> implements MunicipioUseCase {

    private final MunicipioUseCase municipioUC = A_ModuleGestionGeografiaRESTConfig.municipioUC;

    public MunicipioRESTService() {
        setUseCase(municipioUC);
    }
